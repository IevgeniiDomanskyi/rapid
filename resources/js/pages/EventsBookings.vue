        ...
        <v-col>
          <app-panel>
            ...
            <app-table
              ...
              show-select
            >
              <template v-slot:[`item.eventField`]="{ item }">
  ...
  export default {
    ...
    data: () => ({
      ...
      headers: [
        ...
        { text: 'Event ID', value: 'event.event_id', },
        { text: 'Event', value: 'eventField', },
    ...
    computed: {
      ...mapState({
        bookings: state => state.events.bookings,
      }),
      ...
      bookingsModified() {
        ...
        for (const key in this.bookings) {
          ...
          item.eventField = item.event.name

          item.regionField = (item.event.region ? item.event.region.title : '')
          item.coachField = item.event.coach ? (item.event.coach.firstname + ' ' + item.event.coach.lastname) : ''
